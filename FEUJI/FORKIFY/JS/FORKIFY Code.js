...
nextButton.addEventListener("click",nextPage);
   ...
   var recipeIngList;
var cookName=document.querySelector(".name_cook");
var sourceLink=document.querySelector(".souce_link");
  ...
  function prevPage(){                                                               //function previous page
	...
	function displayRecipeIngridients()	{
		// recipeIngList.innerHTML="";
		 ...
		 cookName.innerHTML=jsonDataForIngridients.recipe.publisher;
		 sourceLink.innerHTML=jsonDataForIngridients.recipe.source_url;
